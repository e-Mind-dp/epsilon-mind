...
# # --------------------------
# sns.set_theme(style="whitegrid")  # Base theme similar to ggplot
# sns.set_palette("muted")  # Soft color tones

# # Set matplotlib parameters to mimic ggplot
# plt.rcParams.update({
#     'axes.edgecolor': 'gray',
#     'axes.linewidth': 0.8,
#     'axes.titlesize': 16,
...
# # --------------------------
# # Plot Boxplot of Frequencies
# # --------------------------

# # Create a long-form DataFrame for seaborn boxplot
# import pandas as pd

# data = []

# for i, attacker in enumerate(attacker_labels):
#     for j in range(len(epsilon_policy)):
#         data.append({
#             "Attacker": attacker,
#             "Privacy Budget Index": j,
#             "Frequency": heatmap_matrix[i, j]
#         })

# df = pd.DataFrame(data)

# plt.figure(figsize=(10, 6))
# sns.boxplot(x="Attacker", y="Frequency", data=df)
# plt.title("Distribution of Privacy Budget Selection Frequencies by Attacker")
# plt.ylabel("Selection Frequency")
# plt.xlabel("Attacker Strategy")
# plt.tight_layout()
# plt.savefig("post_optimizer/attacker_focus_boxplot.png", dpi=300)
# plt.show()
